...
import HealthTrends from "@/components/profile/HealthTrends";
import DoshaPressureTimeline from "@/components/profile/DoshaPressureTimeline";
import InsightTimeline from "@/components/profile/InsightTimeline";
import PatternInsights from "@/components/profile/PatternInsights";
...
export default function HistoryPage() {
    ...
    const deleteLog = async (id: string) => {
        if (!window.confirm("Are you sure you want to permanently delete this biological log?")) return;
                ...
                {loading ? (
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            <DoshaPressureTimeline logs={logs} />
                            <InsightTimeline logs={logs} />
                        </div>

                        {/* Behavioral Memory — Pattern Insights */}
                        <PatternInsights />

                        <div className="h-px w-full bg-forest/10 my-16" />
