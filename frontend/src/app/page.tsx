        ...
        <LazyMotion features={domAnimation}>
            <div className="bg-[#F8FAF9] text-slate-800 min-h-screen relative font-sans selection:bg-forest/20 selection:text-forest overflow-hidden" style={{ transform: "translateZ(0)" }}>
              ...
              <div className="flex-1 space-y-8">
                {/* Eyebrow */}
                <p className="text-xs font-black text-forest/90 uppercase tracking-[0.3em]">
                ...
                <div className="relative bg-white border border-slate-100 rounded-[2.5rem] shadow-premium p-6 md:p-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      <p className="text-xs uppercase font-black text-slate-600 tracking-widest">
                        Example Insight
                      </p>
                    ...
                    <div className="bg-[#F8FAF9] p-4 rounded-xl border border-slate-100">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-black text-emerald-700 uppercase">Optimal</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <section id="features" className="py-16 md:py-24 px-6 bg-white border-y border-slate-100 relative z-10">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="text-center md:text-left p-6 transition-all">
                        ...
                        <h2 className="text-xl font-black text-forest mb-3 tracking-tight">Know Your Body Type</h2>
                    ...
                    <div className="text-center md:text-left p-6 transition-all">
                        ...
                        <h2 className="text-xl font-black text-forest mb-3 tracking-tight">Track Daily Rhythms</h2>
                    ...
                    <div className="text-center md:text-left p-6 transition-all">
                        ...
                        <h2 className="text-xl font-black text-forest mb-3 tracking-tight">Personalized Rituals</h2>
            ...
            <section className="py-16 md:py-24 px-6 relative z-10 max-w-3xl mx-auto">
                <h2 className="text-xs font-black text-slate-600 uppercase tracking-[0.3em] mb-4 text-center">The Wellness Paradox</h2>
                ...
                <div className="space-y-8 mb-16 relative">
                    <div className="border-l-4 border-emerald-500 pl-6 space-y-2 py-2">
                        <div className="text-xs font-black text-emerald-700 uppercase tracking-widest">01</div>
                    ...
                    <div className="border-l-4 border-amber-500 pl-6 space-y-2 py-2">
                        <div className="text-xs font-black text-amber-700 uppercase tracking-widest">02</div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-lg font-black text-forest mb-3">Take a Short Assessment</h3>
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-lg font-black text-forest mb-3">Dinaveda Maps Your Profile</h3>
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center group">
                            ...
                            <h3 className="text-lg font-black text-forest mb-3">Receive Your Protocol</h3>
                ...
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-center items-center text-center md:text-left gap-10 md:gap-16">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                            <p className="font-black tracking-widest uppercase text-sm text-emerald-100 mb-1">Built by Experts</p>
                    ...
                    <div className="flex items-center gap-4">
                        <CheckCircle2 className="w-8 h-8 text-gold shrink-0" />
                        <div className="text-left">
                            <p className="font-black tracking-widest uppercase text-sm text-emerald-100 mb-1">Evidence-Based</p>
                    ...
                    <div className="flex items-center gap-4">
                        <CheckCircle2 className="w-8 h-8 text-gold shrink-0" />
                        <div className="text-left">
                            <p className="font-black tracking-widest uppercase text-sm text-emerald-100 mb-1">Deep Tradition</p>
                ...
                <div className="max-w-5xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                        <div className="bg-emerald-900/40 p-6 rounded-3xl border border-emerald-800/50">
                            <h3 className="text-lg font-black mb-2 tracking-wide">Day 1</h3>
                            <p className="text-sm text-emerald-200">
                                Baseline constitution mapped.
                            </p>
                        </div>
                        <div className="bg-emerald-900/40 p-6 rounded-3xl border border-emerald-800/50">
                            <h3 className="text-lg font-black mb-2 tracking-wide">Day 7</h3>
                            <p className="text-sm text-emerald-200">
                                Patterns detected in sleep and digestion.
                            </p>
                        </div>
                        <div className="bg-emerald-900/40 p-6 rounded-3xl border border-emerald-800/50">
                            <h3 className="text-lg font-black mb-2 tracking-wide">Day 30</h3>
                            <p className="text-sm text-emerald-200">
                     ...
                     <div className="space-y-4">
                        {FAQS.map((faq, idx) => (
                            <div key={idx} className="border border-slate-100 rounded-3xl overflow-hidden hover:border-forest/20 transition-all bg-slate-50/50">
                                ...
                                >
                                    <h3 className="font-black text-forest pr-4">{faq.q}</h3>
